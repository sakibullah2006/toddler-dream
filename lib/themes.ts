...
export const THEMES: PortraitTheme[] = [
  ...
  },
  {
    ...
    compositePrompt:
      "Composite 3 images into one seamless studio-quality baby portrait: (1) Baby photo = preserve face, hair, posture, features exactly, (2) Background scene = deep outer space with nebula, stardust, distant planets, and cosmic lighting effects, (3) Clothing = pristine white astronaut suit with transparent spherical helmet. Blend them so the baby wears the astronaut suit in the cosmic scene with helmet reflections and cinematic space lighting. Keep baby identity 100% unchanged. Output as hyper-realistic professional newborn photography.",
    color: "#4a5f7f",
  },
];
